...
Prefix key default `Ctrl-b` saya ganti menjadi `Ctrl-a`. Alasannya praktis yakni posisi tombol `Ctrl` dan `a` berdekatan sehingga lebih mudah dijangkau dengan satu tangan:
