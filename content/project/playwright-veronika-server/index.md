...
type = 'project'
description = 'A headless browser automation server for testing Telkomsel Veronika chatbot: send a message via REST API, get the response back with a screenshot.'
image = ''
