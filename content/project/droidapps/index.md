...
title = 'DroidApps'
type = 'project'
description = 'A Bash script that runs Android apps in their own windows on Linux — pick an app from rofi, it launches on a secondary display and mirrors via scrcpy.'
image = ''
