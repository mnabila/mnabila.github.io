...
type = 'project'
description = 'The mobile counterpart to Playwright Veronika Server -- same REST API, but driving the actual MyTelkomsel Android app on real devices via Appium.'
image = ''
