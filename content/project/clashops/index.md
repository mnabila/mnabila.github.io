...
**Device communication layer.** Wraps ADB commands for screen capture, tap execution, swipe gestures, and device state queries. This layer abstracts the differences between physical devices, standard emulators, and Waydroid, and the rest of the application does not need to know what kind of device it is talking to.
