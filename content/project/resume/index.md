...
title = 'Resume'
type = 'project'
description = 'The Hugo theme powering this site: warm-toned, resume-as-structured-data, taxonomy-driven tech stacks, and Tailwind CSS v4 with no build tooling beyond npm.'
image = ''
...
- **Taxonomy-driven tech stacks**: languages and tools are Hugo taxonomies, not just display strings. Each language and tool automatically gets its own listing page showing all projects and skills that reference it. Cross-referencing works without manual linking
...
The theme includes a complete `exampleSite/` with sample content for every section like experience, education, skills, projects, and blog posts. Include with a GitHub Actions workflow for deployment to GitHub Pages.
...
The full source is available on [GitHub](https://github.com/mnabila/resume).
