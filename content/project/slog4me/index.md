...
title = 'slog4me'
type = 'project'
description = 'A small Go library that adds template-based formatting and level-based routing to log/slog under 100 lines, built with generics.'
image = ''
...
The library is intentionally minimal only have two files, one external dependency:
